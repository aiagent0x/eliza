            ...
            switch (content.type) {
                ...
                case "GAINERS":
                    ...
                    if (callback) {
                        ...
                        callback({
                            user: await runtime.character.name,
                            text: `Here’s a collection of Gainers tokens we’ve gathered for you!`,
                            action: 'TOP_TOKEN',
                            result: {
                                type: "top_token",
                                data: responseData.slice(0, size)
                ...
                case "LOSERS":
                    ...
                    if (callback) {
                        ...
                        callback({
                            user: await runtime.character.name,
                            text: `Here’s a collection of Losers tokens we’ve gathered for you!`,
                            action: 'TOP_TOKEN',
                            result: {
                                type: "top_token",
                                data: responseData.slice(0, size)
                ...
                case "STABLECOIN":
                    ...
                    if (callback) {
                        ...
                        callback({
                            user: await runtime.character.name,
                            text: `Here’s a collection of StableCoin tokens we’ve gathered for you!`,
                            action: 'TOP_TOKEN',
                            result: {
                                type: "top_token",
                                data: responseData.slice(0, size)
                ...
                case "LISTING":
                    ...
                    callback({
                        user: await runtime.character.name,
                        text: `Top tokens that are about to have their TGE, token release, or exchange listing: BIRDS, FANTV, Haedal`,
                    })
                    return true;
                    break;
            }
