...
The following are project names within the Sui Network: SUI, Cetus, NAVI, DeepBook, Walrus, BIRDS, FanTV, Wave, 7K, Haedal, Aftermath, Bluefin, BlueMove, Turbos, Hop Aggregator, Bucket Protocol, Scallop, Memefi, Tradeport, SuiNS, Suilend, SuiPlay, RaidenX, Typus Finance, Kriya, FlowX, Sudo Finance, AlphaFi, Kai Finance, Strater, Volo, Suiet, Ethos Wallet, Surf Wallet, Nightly, Martian Wallet, Stashed, Suia, SeaPad, DARKTIMES, Cosmocadia, Panzerdogs, MotoDEX, Capybara, Sacabam, SuDeng, Blub, Fud the Pug, Suiman, Suipad, Rockee AI, Sui, Lofi, Sui Agents, SuiAI, AXOL, Agent S, LumiWave, Bucket, Rockee, Toilet Dust, Sui wallet, Wormhole, Pyth, SuiVision, Agora, Stork Oracle, Nansen, Talus Network, Lombard Protocol, Tusky, Utila, Momentum, Karrier one, Astro, SpringSui, STEAMM, Ika, Magma, RedStone, Dynamic, Lofi The Yeti, Artinals, Toilet Dust, Nemo Protocol, Hippo, aiSui, DoubleUp, RWADepin Protocol, Giverep, SQUIRT, VRAM, Aida, Liquid Agents, EkkoAI, Ponzichu, The Pumpkin Token, Uni, Suimon, Tardi, InfiniteSuiGlitch, Bob, POSUIDON, Splash, Noodles Finance, XOCIETY, SUIKACHU, MudkipsOnSui, MevX, PUPUI, PsyDuck, Loftus on sui, Nautilus Agent, Sroom AI DAO, Sola, Jelly AI, Osiris, Neonet, StoneFish AI, Boom Bots AI, OlivAI, Alpha City, Mojito, Asymptotic, Claynosaurz, Bluey, NOT SUI, Sui Booster, MIU, Suinami, WET on SUI, Suigar, EnsoFi, NODO, OSHI3, Pepe on SUI, Super-B, SUI Cars, Suify - Sui CoffeeBot, Alpha4, Suigetsu, SuiRewards.Ne, FATE, voidbet, PlopSui, Beeg Blue Whale, SuiBets, PugWif,. All project names are recognized regardless of case format.

The following are token symbols within the Sui Network: SUI, NS, kSUI, WBNB, USDY, CAPO, SEND, USDT, DEEP, FLX, ALPHA, SPAM, FDUSD, AFSUI, WETH, SPT, SUIP, HOPI, CETUS, MOVE, wUSDC, WFTM, ARTFI, SOL, USDC, haSUI, PIGU, PRH, FUD, AXOL, SCB, KOTO, JWLSUI, BLUB, AUSD, TYPUS, ETH, SCA, vSUI, SSWP, sSUI, stSUI, SUIA, SCUBA, Chad, WMATIC, NAVX, BLUE, PDO, OINK, HSUI, TURBOS, BUCK, WBTC, WAVAX, APT, REAP, PSH, ROCK, Toilet, LBTC, SSUI, LOFI, TOILET, SUIRWAPIN, SUIAGENT, UP, ATTN, AIDA, PCHU, PUMPKIN, Uni, SUIMON, TARDI, ISG, SHRO, SOLA, JAI, OSIRI, NEONET, SAI, BOOM, CITY, BLUEY, NOTS, BOOST, MIU, NAMI, WET, E.D.A.S, OSHI, PEPE, SUIFFY, SRM, FATE, PLOP, BEEG, SBets, PUGWIF. All token symbols are recognized regardless of case format.
...
export const projectInfo: Action = {
    ...
    handler: async (
        ...
        if (tokenObject) {
            ...
            console.log("tokenSuiInfo.coingecko_coin_id :",tokenSuiInfo.coingecko_coin_id );
            console.log("tokenObject.coinGeckoId :",tokenObject.coinGeckoId );
